 ...
 * integer type. It should not affect your implementation, as the integer's 
...
// initial solution, just shift n's bits right and check the rightmost bit.
// perf 100% mem 75%
class Solution
{
public:
    ...
    {
        char count = 0; // only need 6 bits to store up to 32, but bit_set doesn't let you increment.
